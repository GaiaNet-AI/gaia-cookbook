...
var NetworkSchema = import_zod2.z.enum(["base-sepolia", "base", "avalanche-fuji", "avalanche"]);
...
function useFacilitator(facilitator) {
  async function verify2(payload, paymentRequirements) {
    ...
    const res = await fetch(`${url}/verify`, {
      method: "POST",
      headers: facilitator?.createAuthHeaders ? (await facilitator.createAuthHeaders()).verify : void 0,
      body: JSON.stringify({
  ...
  async function settle2(payload, paymentRequirements) {
    ...
    const res = await fetch(`${url}/settle`, {
      method: "POST",
      headers: facilitator?.createAuthHeaders ? (await facilitator.createAuthHeaders()).settle : void 0,
      body: JSON.stringify({
        x402Version: payload.x402Version,
        paymentPayload: toJsonSafe(payload),
        paymentRequirements: toJsonSafe(paymentRequirements)
