...
const sentimentAgent = new Agent({
  ...
  instructions:
    "You are an expert in sentiment analysis. Analyze the text and determine if the sentiment is positive, negative, or neutral. Respond only with the identified sentiment.",
